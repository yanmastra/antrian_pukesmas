...
<html lang="en">
  ...
  <head>
    ...
    <title>Website Resmi Puskesmas Kuta Selatan</title>
...
function MM_swapImage() { //v3.0
  ...
  <body id="page-top" onLoad="MM_preloadImages('img/buttom2.png')">

    <!-- Navigation -->
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="http://localhost/Antri/">PUSKESMAS KUTA SELATAN</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#">RIWAYAT</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#masuk">SETTING USER</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#daftar">LOGOUT</a>
            </li>
          </ul>
        </div>
      </div>
 ...
 <header class="masthead">
	<div class="container">
		<div class="row">
         <div class="col-lg-6">
			<h4 class="text-left">Indentitas anda</h4>
					<table border="1">
		<tr>
			<th>No</th>
			<th>Tgl</th>
